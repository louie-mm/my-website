...
function Intro() {
    return (
        <div className={"intro-container"}>
            <p className={"intro"}>NEW Hi! My name's Louie! I'm a professional developer living in Toronto. When I'm not building applications for work, you can find me developing my skill-sets with projects and books.</p>
